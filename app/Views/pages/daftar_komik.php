    ...
    <div class="row mx-0 bg-white rounded">
        <div class="col-12 p-4">
            ...
            <div class="row" style="padding-bottom: calc(var(--bs-gutter-x) * 0.5)">
                <div class="col-12 comic-col" style="padding-top: calc(var(--bs-gutter-x) * 0.5); padding-bottom: calc(var(--bs-gutter-x) * 0.5)" onclick="window.location.href = '<?= site_url('detail_komik') ?>'">
