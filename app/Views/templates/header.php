    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-white py-4">
            <div class="container-fluid container-lg">
                <a class="navbar-brand bg-primary text-white px-3 rounded fw-bold" href="<?= site_url() ?>">KomikZone</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item ms-lg-4">
                            <a class="nav-link <?= ($title == 'Faq') ? 'active' : '' ?>" href="<?= site_url('faq') ?>">FAQ</a>
                        </li>
                    </ul>
                    <form class="d-flex" role="search" action="<?= site_url('daftar_komik') ?>">
